...
const setActiveStateOfNavItem = function (item: DropDownNavItemProps, index: number, path: string) {
	let active: boolean;
...
const SimpleHeaderWithoutRouter: React.FC<SimpleHeaderProps & RouteComponentProps> = ({
	primaryTitle,
	secondaryTitle,
	navItems,
	logoutPath = '/logout',
			...
			>
				...
				>
					<div className={cx('usa-nav__inner')}>
						<div className={cx('usa-nav__secondary', 'usa-nav__secondary--centered', 'usa-accordion')}>
